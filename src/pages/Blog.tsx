          ...
          <div className="mt-20">
            <div className="text-center mb-8">
              <h2 className="text-xl sm:text-2xl font-bold mb-6 text-white">
                "Building the future, one line of code at a time" - Roshni
              </h2>
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 max-w-4xl mx-auto">
                <a 
                  ...
                  className="bg-white/10 hover:bg-white/20 border border-white/20 rounded-2xl p-4 transition-all duration-300 hover:scale-105 text-center"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-2xl p-4 transition-all duration-300 hover:scale-105 text-center"
                >
                  <div className="text-blue-400 font-medium text-base">Hashnode</div>
                </a>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-orange-500/20 hover:bg-orange-500/30 border border-orange-500/30 rounded-2xl p-4 transition-all duration-300 hover:scale-105 text-center"
                >
                  <div className="text-orange-400 font-medium text-base">Substack</div>
                </a>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 rounded-2xl p-4 transition-all duration-300 hover:scale-105 text-center"
                >
                  <div className="text-red-400 font-medium text-base">YouTube</div>
                </a>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-purple-500/20 hover:bg-purple-500/30 border border-purple-500/30 rounded-2xl p-4 transition-all duration-300 hover:scale-105 text-center"
                >
                  <div className="text-purple-400 font-medium text-base">Workshops</div>
                </a>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-green-500/20 hover:bg-green-500/30 border border-green-500/30 rounded-2xl p-4 transition-all duration-300 hover:scale-105 text-center"
                >
                  <div className="text-green-400 font-medium text-base">Portfolio</div>
                </a>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-red-900/30 to-orange-900/30 backdrop-blur-sm border border-red-500/20 rounded-2xl p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                  type="email"
                  placeholder="Email"
                  className="flex-1 px-4 py-3 bg-black/50 border border-white/20 rounded-2xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-blue-500 text-base"
                />
                <button className="bg-white text-black px-6 py-3 rounded-2xl font-medium transition-all duration-300 hover:scale-105 text-base">
                  Subscribe
                </button>
              </div>
            </div>
